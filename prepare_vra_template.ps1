...
# function to define the file versions we download based on the version of vRA
function SetFileVersions($Version)
{
  if ( $Version -eq "7.0" )
  {
    $bootstrapFile="vmware-vra-software-agent-bootstrap-windows_7.0.0.0.zip"
    $agentFile="GuestAgentInstaller_x64.exe"
    $javaFile="jre-1.8.0_66-win64.zip"
  }
  elseif ( $Version -eq "7.0.1" )
  {
    $bootstrapFile="vmware-vra-software-agent-bootstrap-windows_7.0.0.0.zip"
    $agentFile="GuestAgentInstaller_x64.exe"
    $javaFile="jre-1.8.0_72-win64.zip"
  }
  elseif ( $Version -eq "7.1" )
  {
    $bootstrapFile="vmware-vra-software-agent-bootstrap-windows_7.1.0.0.zip"
    $agentFile="GuestAgentInstaller_x64.exe"
    $javaFile="jre-1.8.0_92-win64.zip"
  }
}
# ----------------------------------------
# 	     End Functions
...
$msg =  "The version you have is set to ";$BackgroundColor = "Black";$ForegroundColor = "Green";Write-Feedback


# ----------------------------------------
# Call Set file versions function
SetFileVersions $Version
...
$url="https://" + $vRAurl + ":5480/service/software/download/" + $javaFile
...
$url="https://" + $vRAurl + ":5480/installer/" + $agentFile
...
cd C:\opt\bootstrap
$url="https://" + $vRAurl + ":5480/service/software/download/" + $bootstrapFile
